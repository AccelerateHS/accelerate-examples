...
makeLights _time
  = A.fromList (Z :. 1) [ Light_ (V3 300 (-300) (-100))
...
makeObjects time
  = let
        spheres = A.fromList (Z :. 4)
          [ Sphere_ (V3 (40 * sin time) 80 0.0)
                    20
                    (RGB 1.0 0.3 1.0)
                    0.4

          , Sphere_ (V3 (200 * sin time) (-40 * sin (time + pi/2)) (200 * cos time))
                    100.0
                    (RGB 0.4 0.4 1.0)
                    0.8

          , Sphere_ (V3 (-200.0 * sin time) (-40 * sin (time - pi/2)) (-200 * cos time))
                    100.0
                    (RGB 0.4 0.4 1.0)
                    0.5

          , Sphere_ (V3 0.0 (-150.0) (-100.0))
                    50.0
                    (RGB 1.0 1.0 1.0)
                    0.8
          ]
